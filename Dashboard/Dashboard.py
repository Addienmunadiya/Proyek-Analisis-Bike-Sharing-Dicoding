...
st.text("Addien Munadiya Yunadi")

# Loading data dan persiapan
@st.cache_data
def load_data():
    day_df = pd.read_csv("https://github.com/Addienmunadiya/Proyek-Analisis-Bike-Sharing-Dicoding/blob/main/Dashboard/day.csv")
    hr_df = pd.read_csv("https://github.com/Addienmunadiya/Proyek-Analisis-Bike-Sharing-Dicoding/blob/main/Dashboard/hour.csv")
